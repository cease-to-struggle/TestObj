...
<link rel="stylesheet" type="text/css" href="admins/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="admins/css/style.css">
<link rel="stylesheet" type="text/css" href="admins/css/font-awesome.min.css">
<link rel="apple-touch-icon-precomposed" href="admins/images/icon/icon.png">
<link rel="shortcut icon" href="admins/images/icon/favicon.ico">
<script src="admins/js/jquery-2.1.4.min.js"></script>
<!--[if gte IE 9]>
  <script src="admins/js/jquery-1.11.1.min.js" type="text/javascript"></script>
  <script src="admins/js/html5shiv.min.js" type="text/javascript"></script>
  <script src="admins/js/respond.min.js" type="text/javascript"></script>
  <script src="admins/js/selectivizr-min.js" type="text/javascript"></script>
<![endif]-->
<!--[if lt IE 9]>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="{{ route('logout') }}" onClick="if(!confirm('是否确认退出？'))return false;">退出登录</a></li>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="admins/images/weixin.jpg" alt="" style="cursor:pointer"/> </div>
    </div>
  </div>
</div>
<!--提示模态框-->
<div class="modal fade user-select" id="areDeveloping" tabindex="-1" role="dialog" aria-labelledby="areDevelopingModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> <img src="admins/images/baoman/baoman_01.gif" alt="深思熟虑" />
...
<script src="admins/js/admin-scripts.js"></script>
</body>
</html>
